<template>
    <div class="container " style="margin-top:0px">
         <div class="container section ">
           ...
           <h3 class="center align-center" style="font-family: Prompt">1/12</h3>
        <div class="row teal darken-1" style="padding:10px;">
...
export default {
    ...
    methods:{ 
        ...
        GetQA:function(){     
          var self = this
          let QuestionRef = db.collection('Q&A').doc('Question&Answer').collection('Posttest').doc('Number1');
        ...
        C1Clicked:function(){
            ...
            if(choice==self.ArrayQ.Anum){
             ...
             const item={
                ...
                db.collection('UserData').doc('PostTest').collection('PostTestScore').doc(self.userTable).set(item).then(res=>{
                      self.PostTestNumber1="";
                 })
                 console.log(self.email,self.userTable)
                 self.$router.push({name: 'PostTest2'})
        },  
        C2Clicked:function(){
                var self = this
