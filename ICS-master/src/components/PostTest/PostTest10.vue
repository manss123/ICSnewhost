<template>
    <div class="container" style="margin-top:0px">
         <div class="container section">
           ...
           <h3 class="center align-center" style="font-family: Prompt">10/12</h3>
        <div class="row red accent-1" style="padding:10px;">
...
export default {
    ...
    methods:{
        ...
        GetQA:function(){     
          var self = this
          let QuestionRef = db.collection('Q&A').doc('Question&Answer').collection('Posttest').doc('Number10');
            ...
            if(choice==self.ArrayQ.Anum){
             ...
             const item={
                ...
                db.collection('UserData').doc('PostTest').collection('PostTestScore').doc(self.userTable).update(item).then(res=>{
                      self.PostTestNumber10="";
                 })
                 self.$router.push({name: 'PostTest11'})
        },  
        C2Clicked:function(){
                var self = this
