<template>
    <div class="container" style="margin-top:0px">
         <div class="container section">
           ...
           <h3 class="center align-center" style="font-family: Prompt">4/12</h3>
...
export default {
    ...
    methods:{
        ...
        GetQA:function(){     
          var self = this
          let QuestionRef = db.collection('Q&A').doc('Question&Answer').collection('Posttest').doc('Number4');
            ...
            if(choice==self.ArrayQ.Anum){
             ...
             const item={
                ...
                db.collection('UserData').doc('PostTest').collection('PostTestScore').doc(self.userTable).update(item).then(res=>{
                      self.PostTestNumber4="";
                 })
                 self.$router.push({name: 'PostTest5'})
        },  
        C2Clicked:function(){
                var self = this
