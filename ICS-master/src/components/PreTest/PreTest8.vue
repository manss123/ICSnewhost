        ...
        <div class="row light-green darken-1" style="padding:10px;">
            ...
            <div class="col s12 m12 l12" name="ChoiceDiv" id="ChoiceDiv" style="margin-top:61px">
                <div class="col s12 m12 l12" id="Div1" name="Div1">
                  <a class="white black-text waves-effect waves-light btn-large col s12 m6 l6 offset-m3 offset-l3" style=" font-family: 'Pridi', serif;line-height:25px;height: 50px; " id="Choice1" @click="C1Clicked" name="1"  >1. {{C1}}</a>
                </div>
                <div class="col s12 m12 l12" id="Div2" name="Div2" style="margin-top:40px;">
                  <a class="white black-text waves-effect waves-light btn-large col s12 m6 l6 offset-m3 offset-l3" style=" font-family: 'Pridi', serif;line-height:25px;height: 50px; " id="Choice2" @click="C2Clicked" name="2">2. {{C2}}</a>
                </div>
                <div class="col s12 m12 l12" id="Div3" name="Div3" style="margin-top:40px;">
                  <a class="white black-text waves-effect waves-light btn-large col s12 m6 l6 offset-m3 offset-l3" style=" font-family: 'Pridi', serif;line-height:25px;height: 70px;width:241px; " id="Choice3" @click="C3Clicked" name="3">3. {{C3}}</a>
                </div>
            </div>
...
export default {
    ...
    methods:{
        ...
        GetQA:function(){     
          var self = this
          let QuestionRef = db.collection('Q&A').doc('Question&Answer').collection('PreTest').doc('Number8');
            ...
            if(choice==self.ArrayQ.Anum){
             ...
             const item={
               ...
               db.collection('UserData').doc('PreTest').collection('PretestScore').doc(self.userTable).update(item).then(res=>{
                 ...
                 self.$router.push({name: 'PreTest9'})
        },  
        C2Clicked:function(){
                var self = this
