<template>
    <div class="container" style="margin-top:0px">
         <div class="container section">
           ...
           <h3 class="center align-center" style="font-family: Prompt">5/12</h3>
        <div class="row light-blue darken-1" style="padding:10px;">
            <div class="white col s12 m12" style="padding:0px;">
                ...
                action="#" name="MyForm1" id="MyForm1">
                    <div class="card-content white" style="margin-top:40px;margin-bottom:40px;padding:10px;">
                        <span class="flow-text center" style="font-size:20px;">{{Question}}</span>
                    </div>
            ...
            <div class="col s12 m12 l12" name="ChoiceDiv" id="ChoiceDiv" style="margin-top:61px">
                ...
                <div class="col s12 m12 l12" id="Div3" name="Div3" style="margin-top:40px;">
                  <a class="white black-text waves-effect waves-light btn-large col s12 m6 l6 offset-m3 offset-l3" style=" font-family: 'Pridi', serif;line-height:25px;height:50px;" id="Choice3" @click="C3Clicked" name="3">3. {{C3}}</a>
                </div>
            </div>
...
export default {
    ...
    methods:{
        ...
        GetQA:function(){     
          var self = this
          let QuestionRef = db.collection('Q&A').doc('Question&Answer').collection('PreTest').doc('Number5');
            ...
            if(choice==self.ArrayQ.Anum){
             ...
             const item={
                ...
                db.collection('UserData').doc('PreTest').collection('PretestScore').doc(self.userTable).update(item).then(res=>{
                 ...
                 self.$router.push({name: 'PreTest6'})
        },  
        C2Clicked:function(){
                var self = this
