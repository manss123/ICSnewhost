<template>
    <div class="container " style="margin-top:0px">
         <div class="container section ">
           <h3 class="center align-center" style="font-family: Bahnschrift;">Question 2 of 5</h3>
    ...
    methods:{ 
        ...
        GetQA:function(){     
          ...
          QuestionRef.get(getOptions).then(function(doc) {
              ...
              self.Question = doc.data().Number2.Q;
              self.C1 = doc.data().Number2.C1;
              self.C2 = doc.data().Number2.C2;
              self.C3 = doc.data().Number2.C3;
        ...
        Onsubmit:function(){
          if(this.choice!=null){
            ...
            if(parseInt(this.choice)==self.ArrayQ.Number2.Anum){
              score = score + 1;
            }
             const item={
                QuizNumber2:{
                ...
                //  console.log(self.choice,self.ArrayQ.Anum)
                 self.$router.push({name: 'Chapter1Quiz3'})
                 } 
                },
