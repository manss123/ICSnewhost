<template>
    <div class="container">
        <div style="margin-top:50px;">
            <h1 class="center" style="color:#039be5;">Quiz</h1>
            <div class="row">
        ...
        Quiz1:function(){
            ...
            var Fulldate = "Date: "+getDate+"/"+getMonth+"/"+ getYear+" Time: "+getHour+"."+getMinute+"."+getSec;
             const item={
                ...
                db.collection('UserData').doc('Quiz').collection('QuizChapter1').doc(self.userTable).set(item)
            this.$router.push({name:'Chapter1Quiz1'});
        }
