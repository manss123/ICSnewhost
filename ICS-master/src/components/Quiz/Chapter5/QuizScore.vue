<template>
    <div class="container center">
      ...
      <h3 class="center">สรุปคะแนน Quiz Chapter 5</h3>
    ...
    methods:{
      ...
      createData(){
         ...
         var getOptions = {
          ...
          let UserScoreRef = db.collection('UserData').doc('Quiz').collection('QuizChapter5').doc(self.userTable);
      ...
      calculateTime:function(){
        ...
        ref.get().then(function(doc){
          /////////////////////////////////////////////////////////////
            ...
            db.collection('UserData').doc('Quiz').collection('QuizChapter5').doc(self.userTable).update(item)
        })
      },
