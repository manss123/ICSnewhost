<template>
    <div class="container " style="margin-top:0px">
         <div class="container section ">
           <h3 class="center align-center" style="font-family: Bahnschrift;">Question 5 of 5</h3>
...
export default {
    ...
    methods:{ 
        ...
        GetQA:function(){     
          var self = this
          let QuestionRef = db.collection('Q&A').doc('Question&Answer').collection('Quiz').doc('Chapter4');
          ...
          QuestionRef.get(getOptions).then(function(doc) {
              ...
              self.Question = doc.data().Number5.Q;
              self.C1 = doc.data().Number5.C1;
              self.C2 = doc.data().Number5.C2;
              self.C3 = doc.data().Number5.C3;
        ...
        Onsubmit:function(){
          if(this.choice!=null){
            ...
            if(parseInt(this.choice)==self.ArrayQ.Number5.Anum){
              score = score + 1;
            }
             const item={
                QuizNumber5:{
                ...
                db.collection('UserData').doc('Quiz').collection('QuizChapter4').doc(self.userTable).update(item).then(res=>{
                      self.QuizNumber5="";
                 })
                //  console.log(self.choice,self.ArrayQ.Anum)
                 self.$router.push({name: 'Chapter4QuizScore'})
                 } 
                },
