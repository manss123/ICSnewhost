<template>
    <div class="container " style="margin-top:0px">
         <div class="container section ">
           <h3 class="center align-center" style="font-family: Bahnschrift;">Question 1 of 5</h3>
    ...
    methods:{ 
        ...
        GetQA:function(){     
          ...
          QuestionRef.get(getOptions).then(function(doc) {
              ...
              self.Question = doc.data().Number1.Q;
              self.C1 = doc.data().Number1.C1;
              self.C2 = doc.data().Number1.C2;
              self.C3 = doc.data().Number1.C3;
        ...
        Onsubmit:function(){
          if(this.choice!=null){
            ...
            if(parseInt(this.choice)==self.ArrayQ.Number1.Anum){
              score = score + 1;
            }
             const item={
                QuizNumber1:{
                ...
                db.collection('UserData').doc('Quiz').collection('QuizChapter4').doc(self.userTable).set(item).then(res=>{
                      self.QuizNumber1="";
                 })
                //  console.log(self.choice,self.ArrayQ.Anum)
                 self.$router.push({name: 'Chapter4Quiz2'})
                 } 
                },
