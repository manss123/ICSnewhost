<template>
    ...
    <div class="unit container center col s12 m12 l12 row" style="margin-top:20px">
        ...
        <div class="row card-panel light-blue s12 m12 l12 valign-wrapper white-text">
                    <div class="container col s6 m6 l6 right right-align" style="margin:0%;padding:0%;">
                    <img src="https://dlabi.com/project/interactive-computing-science/Materials/6lesson/Unit_3.png" alt="" class="circle responsive-img col s10 m4 l4 right right-align offset-l4">
                    </div>
                    <div class="left-align flow-text col s8 m8 l8 left" style="margin:0%;font-weight:bold;">ภัยจากมือที่สาม</div> 
        </div>
        ...
        <div class="card-panel container col s12 m10 l10 light-blue lighten-3 offset-m1 offset-l1" style="margin-top:4%;">
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter3/Unit3.1.png" style="margin-top:12px" alt="" class="responsive-img circle col s10 m4 l4 offset-s1 offset-m4 offset-l4">
                            <p class="flow-text col s12 m12 l12" style="margin-top:5px;margin-bottom:2%;padding:2%;font-weight:bold;">มือล่องหนทะลุจอ</p>
                     ...
                     <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter3/Unit3.2.png" style="margin-top:12px" alt="" class="responsive-img circle col s10 m4 l4 offset-s1 offset-m4 offset-l4">
                            <p class="flow-text col s12 m12 l12" style="margin-top:5px;margin-bottom:2%;padding:0px;font-weight:bold;">สองมือตั้งรับ</p>
                    ...
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter3/Unit3.3.png" style="margin-top:12px" alt="" class="responsive-img circle col s10 m4 l4 offset-s1 offset-m4 offset-l4">
                            <p class="flow-text col s12 m12 l12" style="margin-top:5px;margin-bottom:2%;padding:0px;font-weight:bold;">ยื่นมือช่วยเหลือ</p>
        ...
        <div class="col s12 m12 l12">
            <router-link :to="{name: 'UnitHome'}"><a class="waves-effect blue lighten-1 btn-large col s4 m4 l2 flow-text">ย้อนกลับ</a></router-link>
          </div>
...
export default {
    ...
    methods:{
        ...
        DoneStatusCheck:function(userTable){
            ...
            let Chapter3Status = db.collection('UserData').doc('Progress').collection('Chapter3').doc(userTable)
            Chapter3Status.get(getOptions).then(function(doc){
        ...
        QuizCheck:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter3StatusRef = db.collection('UserData').doc('Progress').collection('Chapter3').doc(userTable)
            Chapter3StatusRef.get(GetOptions).then(function(doc){
        ...
        QuizTest:function(){
            this.$router.push({name:'Chapter3QuizIntro'});
        },

        GetCurrentStatus:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter3Ref = db.collection('UserData').doc('Status').collection('Chapter3').doc(userTable)
            Chapter3Ref.get(GetOptions).then(function(doc){
...
/////////////////////////////  Unit1 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C3Unit1EasyIntro'})
            let unit = 'Unit1'
            let level = 'Low'
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
            self.$router.push({name: 'C3Unit1MediumIntro'})
            let unit = 'Unit1'
            let level = 'Medium'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
            self.$router.push({name: 'C3Unit1HardIntro'})
            let unit = 'Unit1'
            let level = 'Good'
            self.RecordLog(unit,level)
...
//////////////////////////////////////////////// Unit 2 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C3Unit2EasyIntro'})
                let unit = 'Unit2'
            let level = 'Low'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C3Unit2MediumIntro'})
                let unit = 'Unit2'
            let level = 'Medium'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C3Unit2HardIntro'})
                let unit = 'Unit2'
            let level = 'Good'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C3Unit3EasyIntro'})
                let unit = 'Unit3'
            let level = 'Low'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C3Unit3MediumIntro'})
                let unit = 'Unit3'
            let level = 'Medium'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C3Unit3HardIntro'})
                let unit = 'Unit3'
            let level = 'Good'
            self.RecordLog(unit,level)
