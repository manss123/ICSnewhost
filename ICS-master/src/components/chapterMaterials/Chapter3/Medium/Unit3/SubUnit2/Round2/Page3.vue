<template>
    ...
    <div class="unit container center col s12 m12 l12" style="margin-top:20px">
        ...
        <div class="row card-panel light-blue s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s6 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                            หากน้องเจอผู้ที่ถูก<br>Cyberbullying น้องจะพูดให้ กำลังใจยังไง
                    </div>
        ...
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 light-blue white-text row" style="margin-top:4%;">
                        <div class="card-panel light-blue lighten-3 col s12 m12 l12 center-align">
                                <h4 style="font-weight:bold;"> 1.</h4>
                                <p class="flow-text">ลืมๆมันไปเถอะ</p>
                        ...
                        <div class="card-panel light-blue lighten-3 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ฉันอยู่กับเธอเสมอนะ</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
                        ...
                        <div class="card-panel light-blue lighten-3 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">เลิกเศร้าได้แล้ว</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
...
export default {
    ...
    methods:{
        ...
        TimeCal:function(Email){
            ...
            let ref = db.collection('UserData').doc('Content').collection('Chapter3').doc('Unit3').collection('Level').doc('Medium').collection('Content').doc(Email);
        ref.get(getOptions).then(function(doc){
            ...
            let StartHour = doc.data().Round2Page2Start.StartTimeHour;
            let EndHour = doc.data().Round2Page2End.EndTimeHour;
            let FinalHour = Math.abs(EndHour-StartHour)*3600;

            let StartMinute = doc.data().Round2Page2Start.StartTimeMinute;
            let EndMinute = doc.data().Round2Page2End.EndTimeMinute;
            let FinalMinute = Math.abs(EndMinute-StartMinute)*60;

            let StartSecond = doc.data().Round2Page2Start.StartTimeSecond;
            let EndSecond = doc.data().Round2Page2End.EndTimeSecond;
            let FinalSecond = Math.abs(EndSecond-StartSecond);

            let P2AllCalculatedSecond = FinalHour+FinalMinute+FinalSecond;
            ...
            db.collection('UserData').doc('Content').collection('Chapter3').doc('Unit3').collection('Level').doc('Medium').collection('Content').doc(Email).update(item)
            db.collection('UserData').doc('Loging').collection('Chapter3').doc('Unit3').collection('Level').doc('Medium').collection('Chapter3Unit3MediumLoging').doc(Email).update(item)
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C3Unit3MediumRound2P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
