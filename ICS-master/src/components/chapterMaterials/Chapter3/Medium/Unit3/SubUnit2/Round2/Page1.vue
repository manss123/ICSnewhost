    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-blue accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <div class="left-align flow-text col s8 m8 l8 left"><h5 style="font-weight:bold;"> ยื่นมือช่วยเหลือ </h5></div> 
            </div>

                    <div class="card light-blue darken-1 col s12 m12 l12 white-text" style="padding:30px;margin-bottom:30px;">
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">คนที่ถูก Cyberbullying อาจไม่กล้าระบายความทุกข์ใจกับใคร ไม่กล้าเล่าสิ่งที่เจอมาให้ใครฟัง มีอาการซึมเศร้า เครียด หรือมีความวิตกกังวล เก็บตัว ไม่ค่อยพูดจา และจะนำไปสู่โรคซึมเศร้าได้</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        หากน้องๆมีเพื่อน หรือ คนที่รู้จักกำลังถูก Cyberbullying น้องๆลองเข้า ไปคุยกับพวกเขาดูนะครับ เพื่อที่จะให้เขาระบายออก มาบ้าง พี่โมโม่มีวิธีแนะนำ ในการคุยกับพวกเขา ตาม มาเลยครับ
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit3MediumRound1P1'}"><a class="waves-effect light-blue waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit3MediumRound1P1'}"><a class="waves-effect light-blue waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit3MediumRound2P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit3MediumRound2P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
