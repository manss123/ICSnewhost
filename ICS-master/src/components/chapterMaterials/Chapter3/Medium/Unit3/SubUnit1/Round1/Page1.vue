    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-blue accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">น้องๆเชื่อไหมครับว่า Cyberbullying เป็นเรื่องที่ไม่ได้ไกลตัวเราเลย เรื่องนี้เป็นประเด็นที่ทุกคนควรตระหนักถึง เพราะขณะที่น้องๆได้อ่านบทความอยู่ตอนนี้ ก็มีผู้ตกเป็นเหยื่อจาก Cyberbullying อีกหลายรายทั่วโลก</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        พี่โมโม่อยากให้น้องๆ ร่วมด้วยช่วยกัน<br>ในการช่วยเหลือคนที่กำลังถูกCyberbullyingอยู่ ลองมาดูสถานการณ์ตัวอย่างกันครับ ว่าน้องๆสามารถช่วยได้อย่างไร
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit3MediumIntro'}"><a class="waves-effect light-blue waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit3MediumIntro'}"><a class="waves-effect light-blue waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit3MediumRound1P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit3MediumRound1P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
