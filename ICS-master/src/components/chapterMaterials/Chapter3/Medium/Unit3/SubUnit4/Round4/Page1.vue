    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-blue accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">ในโลกนี้มีเยาวชนไม่น้อยเลยที่ตกเป็นเหยื่อการรังแกผ่านโลกไซเบอร์ ปัญหาดังกล่าวเชื่อมโยงกับคุณภาพชีวิตของเยาวชนและปัญหาอื่นๆที่เป็นเหตุของการเจ็บป่วยหรือทำร้ายร่างกายอีกด้วย</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        พี่โมโม่มีตัวอย่างบทสัมภาษณ์น้อง ๆ ที่ถูกรักแก 
กลั่นแกล้งทางโลกออนไลน์ในประเทศไทย และต่างประเทศมาให้น้องๆอ่านกันครับ
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit3MediumRound4P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit3MediumRound4P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
