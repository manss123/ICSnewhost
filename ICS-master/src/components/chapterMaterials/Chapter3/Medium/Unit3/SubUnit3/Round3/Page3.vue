<template>
    ...
    <div class="unit container center col s12 m12 l12" style="margin-top:20px">
        ...
        <div class="row card-panel light-blue s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s5 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                            การถูกกลั่นแกล้งบนโลกออน ไลน์มีผลกระด้านใดต่อผู้ถูก แกล้งบ้าง
                    </div>
        ...
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 light-blue accent-1 white-text row" style="margin-top:4%;">
                        <div class="card-panel light-blue darken-1 col s12 m12 l12 center-align">
                                <h4 style="font-weight:bold;"> 1.</h4>
                                <p class="flow-text">ผลกระทบทางสังคม</p>
                        ...
                        <div class="card-panel light-blue darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ผลกระทบด้านการเงิน</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
                        ...
                        <div class="card-panel light-blue darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ผลกระทบด้านเศรฐกิจของประเทศ</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
...
export default {
    ...
    methods:{
        ...
        ref.get(getOptions).then(function(doc){
            ...
            let StartHour = doc.data().Round3Page2Start.StartTimeHour;
            let EndHour = doc.data().Round3Page2End.EndTimeHour;
            let FinalHour = Math.abs(EndHour-StartHour)*3600;

            let StartMinute = doc.data().Round3Page2Start.StartTimeMinute;
            let EndMinute = doc.data().Round3Page2End.EndTimeMinute;
            let FinalMinute = Math.abs(EndMinute-StartMinute)*60;

            let StartSecond = doc.data().Round3Page2Start.StartTimeSecond;
            let EndSecond = doc.data().Round3Page2End.EndTimeSecond;
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C3Unit3MediumRound3P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
