    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-blue accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">การรังแกผ่านโลกไซเบอร์ส่งผลต่อจิตใจ อารมณ์ และคุณภาพชีวิตในโลกจริงทั้งผู้รังแกและผู้ถูกรังแก เป็นความรุนแรงอย่างหนึ่งที่เป็นผลมาจากการขาดความสามารถในการจัดการปัญหาและความเครียดของวัยรุ่น บางรายถึงขั้นพยายามฆ่าตัวตายเพื่อให้หลุดพ้นจากความเครียด</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        น้องๆอยากรู้ไหมครับว่า การถูกรังแกผ่านโลกไซเบอร์ มีผลกระทบอะไรบ้าง ตามมา เลยครับ
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit3MediumRound3P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit3MediumRound3P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
