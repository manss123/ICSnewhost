    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-blue accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <div class="left-align flow-text col s8 m8 l8 left"><h5 style="font-weight:bold;"> สองมือตั้งรับ </h5></div> 
            </div>

                    <div class="card  light-blue darken-1 col s12 m12 l12 white-text" style="padding:30px;margin-bottom:30px;">
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">น้องๆรู้ไหมครับว่าเด็กไทยเกือบ 80% มีประสบการณ์ Cyberbullying ในชีวิตจริง โดย 66% ถูกแกล้งอย่างน้อยสัปดาห์ละครั้ง และอีก 12% ถูกแกล้งทุกวัน</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        พี่โมโม่มีสถานการณ์หนึ่งมา ให่น้องๆชมกันครับ เป็นเรื่อง ราวของนักเรียนหญิงคนหนึ่ง ที่ถูกเพื่อนตัดต่อรูปและโพสต์ ลงโซเชียล มาดูกันครับว่าเธอ จะรู้สึกอย่างไร และตัดสินใจ อย่างไร พร้อมหรือยังครับ ถ้าพร้อมแล้วตามพี่โมโม่มา เลยครับ
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit2MediumIntro'}"><a class="waves-effect light-blue waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit2MediumIntro'}"><a class="waves-effect light-blue waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit2MediumRound1P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit2MediumRound1P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
