        ...
        <div class="container col s12 m12 l12 row">
                <div class="col s12 m12 l12 valign-wrapper" style="margin-top:60px;">
                    <div class="container col s12 m12 l12">
                        <div class="col s12 m12 l12 valign-wrapper" style="margin-top:20px" >
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter3/Unit3.2.png" alt="" class="responsive-img circle col s8 m4 l2 offset-s2 offset-l5 offset-m4">
                        </div>
                        <h4 class="center center-align col s12 m12 l12" style="font-weight:bold;">TWO-HAND GUARD<br> สองมือตั้งรับ</h4>
                ...
                <div class="col s12 m12 l12 valign-wrapper">
                    <div class="box sb1 col s12 m12 l8 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        ยินดีต้อนรับน้องๆเข้าสู่ บทเรียน สองมือตั้งรับ ความสนุกรออยู่ครับน้อง ๆ ตามพี่โมโม่มาเลยครับ
                    </div>
                ...
                <div class="row col s12 m12 l12" style="margin-top:30px">
                    ...
                    <div class="col s6 m6 l6 hide-on-med-and-up">
                            <router-link :to="{name:'C3Unit2MediumRound1P1'}"><a @click="submit" class="waves-effect light-blue waves-light btn-small  right align-center"> เข้าสู่บทเรียน </a></router-link>
                    </div>
                    <div class="col s6 m6 l6 hide-on-small-only">
                            <router-link :to="{name:'C3Unit2MediumRound1P1'}"><a @click="submit" class="waves-effect light-blue waves-light btn-large right align-center"> เข้าสู่บทเรียน </a></router-link>
                    </div>
                 </div>
        </div>
</template>
    ...
    methods:{
        ...
        let Gusers = db.collection("Gusers").orderBy("Email")
          ...
          .then(function(querySnapshot) {
            ...
            db.collection('UserData').doc('Content').collection('Chapter3').doc('Unit2').collection('Level').doc('Medium').collection('Content').doc(self.userTable).set(item).then(res=>{
        ...
        Start:function(email){
            ...
            db.collection('UserData').doc('Loging').collection('Chapter3').doc('Unit2').collection('Level').doc('Medium').collection('Chapter3Unit2MediumLoging').doc(this.email).set(item).then(res=>{
                    self.Starting=""; 
            })
        },
