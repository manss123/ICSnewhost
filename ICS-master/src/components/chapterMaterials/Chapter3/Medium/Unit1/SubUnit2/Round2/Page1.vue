    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-blue accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <div class="left-align flow-text col s8 m8 l8 left"><h5 style="font-weight:bold;"> มือล่องหน<br>ทะลุจอ </h5></div> 
            </div>

                    <div class="card light-blue darken-1 col s12 m12 l12 white-text" style="padding:30px;margin-bottom:30px;">
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">น้องๆรู้จักคำว่า Cyberbullying หรือไม่ครับ คำว่า Bully คือการกลั่นแกล้ง ตั้งแต่การใช้คำพูดเสียดสี ถากถาง ด่าทอ ไปจนถึงการทำร้ายร่างกายและทรัพย์สิน ส่วน Cyberbullying นั้นคือการกลั่นแกล้งผ่าน social media เช่น การโพสข้อความเสียๆ หายๆ รวมถึงการอัพโหลดคลิปเพื่อก่อให้เกิดความอับอาย</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        Cyberbullying สามารถแตก ประเด็นออกไปได้ 6 รูปแบบ น้องๆพร้อมที่จะเรียนรู้ไปกับ พี่โมโม่หรือยังครับ ถ้าพร้อม แล้วตามพี่โมโม่มาเลยครับ
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit1MediumRound1P1'}"><a class="waves-effect light-blue darken-1 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit1MediumRound1P1'}"><a class="waves-effect light-blue darken-1 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit1MediumRound2P2'}"><a @click="submit" class="waves-effect light-blue darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit1MediumRound2P2'}"><a @click="submit" class="waves-effect light-blue darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
