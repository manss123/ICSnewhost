    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-blue accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">สิ่งที่วัยรุ่นไทยใช้กลั่นแกล้งกันในโซเชียลส่วนใหญ่จะใช้เป็นโซเชียลมีเดียต่างๆ ไม่ว่าจะเป็น facebook twitter Line Email รวมไปถึง SMS ก็ยังสามารถใช้ในการกลั่นแกล้งทางสังคมออนไลน์ได้</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        พี่โมโม่มีผลสำรวจจากกลุ่ม นักเรียนมัธยมต้น อายุระ หว่าง 12-16 ปี จำนวน 3,667 คน จาก 8 โรงเรียนในกรุง เทพมหานครเกี่ยวกับการ ใช้โซเชียลมีเดีย อยากรู้ ไหมครับ ตามพี่โมโม่มาเลย
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit1MediumRound3P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit1MediumRound3P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
