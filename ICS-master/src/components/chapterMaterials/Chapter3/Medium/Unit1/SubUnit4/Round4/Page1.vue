    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-blue accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">น้องๆว่าไหมครับ ว่าครั้งหนึ่งในชีวิต เราต่างต้องเคยโดนกลั่นแกล้ง หรือบางครั้งก็อาจเป็นฝ่ายรังแกคนอื่นไปโดยไม่รู้ตัว ไม่ว่าจะเป็นการล้อเลียนเรื่องรูปลักษณ์ทางร่ายกาย เช่น อ้วน ดำ เตี้ย ผมหยิก หรือการล้อเลียนในเรื่องอื่นๆ เช่น รสนิยมทางเพศ การแต่งกาย ชื่อพ่อชื่อแม่ รวมไปจนถึงการใช้ความรุนแรงทำให้เจ็บตัวและเจ็บใจ ล้วนเป็นสาเหตุหนึ่งที่ทำให้เกิดบาดแผลลึกๆ ในใจ ทำให้สูญเสียทั้งความมั่นใจ ความเป็นตัวเอง และรุนแรงไปจนถึงทำให้เด็กอับอายจนไม่อยากมีชีวิตอยู่ต่อไปก็เป็นได้</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit1MediumRound1P1'}"><a class="waves-effect light-blue waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit1MediumRound1P1'}"><a class="waves-effect light-blue waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C3Unit1MediumRound4P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C3Unit1MediumRound4P2'}"><a @click="submit" class="waves-effect light-blue waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
