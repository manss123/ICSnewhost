        ...
        <div class="card-panel container col s12 m10 l10 light-green accent-1 offset-m1 offset-l1" style="margin-top:4%;">
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            ...
                            <div class="center col s12 m12 l12 hide-on-med-and-up" style="margin-bottom:13px;">
                                    <router-link :to="{name:'C4Unit1EasyIntro'}"><a @click="submitU1" class="waves-effect grey darken-1 waves-light btn-small align-center"> เริ่มเรียน </a></router-link>
                            </div>
                            <div class="center col s12 m12 l12 hide-on-small-only" style="margin-bottom:13px;">
                                    <router-link :to="{name:'C4Unit1EasyIntro'}"><a @click="submitU1" class="waves-effect grey darken-1 waves-light btn-large align-center"> เริ่มเรียน </a></router-link>
                            </div>
                    </div>
                     ...
                     <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            ...
                            <div class="center col s12 m12 l12 hide-on-med-and-up" style="margin-bottom:13px;">
                                    <router-link :to="{name:'C4Unit2EasyIntro'}"><a @click="submitU2" class="waves-effect grey darken-1 waves-light btn-small align-center"> เริ่มเรียน </a></router-link>
                            </div>
                            <div class="center col s12 m12 l12 hide-on-small-only" style="margin-bottom:13px;">
                                    <router-link :to="{name:'C4Unit2EasyIntro'}"><a @click="submitU2" class="waves-effect grey darken-1 waves-light btn-large align-center"> เริ่มเรียน </a></router-link>
                            </div>
                    </div>
                    ...
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            ...
                            <div class="center col s12 m12 l12 hide-on-med-and-up" style="margin-bottom:13px;">
                                    <router-link :to="{name:'C4Unit3EasyIntro'}"><a @click="submitU3" class="waves-effect grey darken-1 waves-light btn-small align-center"> เริ่มเรียน </a></router-link>
                            </div>
                            <div class="center col s12 m12 l12 hide-on-small-only" style="margin-bottom:13px;">
                                    <router-link :to="{name:'C4Unit3EasyIntro'}"><a @click="submitU3" class="waves-effect grey darken-1 waves-light btn-large align-center"> เริ่มเรียน </a></router-link>
                            </div>
                    </div>
        </div>
        <div class="col s12 m12 l12">
            <a class="waves-effect light-green darken-1 btn-large col s4 m4 l2 flow-text">ย้อนกลับ</a>
          </div>
    ...
    methods:{
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            db.collection('UserData').doc('Content').collection('Chapter4').doc('Unit1').collection('Level').doc('Medium').collection('Content').doc(self.userTable).set(item).then(res=>{
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            db.collection('UserData').doc('Content').collection('Chapter4').doc('Unit2').collection('Level').doc('Medium').collection('Content').doc(self.userTable).set(item).then(res=>{
                      self.Round1Page1Start="";
            })
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            db.collection('UserData').doc('Content').collection('Chapter4').doc('Unit3').collection('Level').doc('Medium').collection('Content').doc(self.userTable).set(item).then(res=>{
                      self.Round1Page1Start="";
            })
