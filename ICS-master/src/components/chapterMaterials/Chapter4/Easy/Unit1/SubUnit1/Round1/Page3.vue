...
export default {
    ...
    methods:{
        ...
        TimeCal:function(Email){
            ...
            let ref = db.collection('UserData').doc('Content').collection('Chapter4').doc('Unit1').collection('Level').doc('Easy').collection('Content').doc(Email);
        ref.get(getOptions).then(function(doc){
            ...
            db.collection('UserData').doc('Content').collection('Chapter4').doc('Unit1').collection('Level').doc('Easy').collection('Content').doc(Email).update(item)
            db.collection('UserData').doc('Loging').collection('Chapter4').doc('Unit1').collection('Level').doc('Easy').collection('Chapter4Unit1EasyLoging').doc(Email).update(item)
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C4Unit1EasyRound1P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
