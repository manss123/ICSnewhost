    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-green accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <div class="left-align flow-text col s8 m8 l8 left"><h5 style="font-weight:bold;"> กลลวง </h5></div> 
            </div>

                    <div class="card light-green darken-1 col s12 m12 l12 white-text" style="padding:30px;margin-bottom:30px;">
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">การทำธุรกรรมออนไลน์ในปัจจุบัน กำลังได้รับความนิยมอย่างสูงนะครับ เพราะทั้งสะดวก และรวดเร็ว ไม่ต้องเสียเวลาเดินทางไปธนาคารให้ยุ่งยาก แต่ข้อเสียของมันก็มี นั่นคือ ความเสี่ยงต่อการที่ข้อมูลทางการเงินของเรารั่วไหล และอาจตกไปอยู่ในมือของผู้ที่ไม่หวังดีได้</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        น้องๆเคยทำธุรกรรมออน ไลน์กันหรือเปล่าครับ แล้วถ้าน้องๆถูกหลอกจะ ต้องทำยังไง รู้ไหมครับ ถ้าไม่รู้พี่โมโม่จะบอกให้ครับ
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C4Unit3MediumRound3P2'}"><a @click="submit" class="waves-effect light-green darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C4Unit3MediumRound3P2'}"><a @click="submit" class="waves-effect light-green darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
