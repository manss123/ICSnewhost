        ...
        <div class="container col s12 m12 l12 row">
                <div class="col s12 m12 l12 valign-wrapper" style="margin-top:60px;">
                    <div class="container col s12 m12 l12">
                        <div class="col s12 m12 l12 valign-wrapper" style="margin-top:20px" >
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter4/unit4.3.png" alt="" class="responsive-img circle col s8 m4 l2 offset-s2 offset-l5 offset-m4">
                        </div>
                        <h4 class="center center-align col s12 m12 l12" style="font-weight:bold;">Trickery<br> กลลวง </h4>
                ...
                <div class="col s12 m12 l12 valign-wrapper">
                    <div class="box sb1 col s12 m12 l8 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        ยินดีต้อนรับน้องๆเข้าสู่ บทเรียน กลลวง ความ สนุกรออยู่ครับน้องๆ ตามพี่โมโม่มาเลยครับ
                    </div>
                ...
                <div class="row col s12 m12 l12" style="margin-top:30px">
                    ...
                    <div class="col s6 m6 l6 hide-on-med-and-up">
                            <router-link :to="{name:'C4Unit3MediumRound1P1'}"><a @click="submit" class="waves-effect light-green darken-1 waves-light btn-small  right align-center"> เข้าสู่บทเรียน </a></router-link>
                    </div>
                    <div class="col s6 m6 l6 hide-on-small-only">
                            <router-link :to="{name:'C4Unit3MediumRound1P1'}"><a @click="submit" class="waves-effect light-green darken-1 waves-light btn-large right align-center"> เข้าสู่บทเรียน </a></router-link>
                    </div>
                 </div>
        </div>
</template>
...
export default {
    ...
    methods:{
        ...
        Start:function(email){
            ...
            db.collection('UserData').doc('Loging').collection('Chapter4').doc('Unit3').collection('Level').doc('Medium').collection('Chapter4Unit3MediumLoging').doc(this.email).set(item).then(res=>{
                    self.Starting=""; 
            })
        },
