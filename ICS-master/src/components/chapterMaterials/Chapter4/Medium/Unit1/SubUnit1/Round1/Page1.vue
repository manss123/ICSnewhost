    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel light-green accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">ปัจจุบันนั้นมีเว็บไซต์ที่ลงข่าวปลอมอยู่ค่อนข้างมาก และมีการแชร์ไปบนโซเชียลต่าง ๆ โดยเฉพาะ Facebook ที่คนไทยนิยมใช้กันมากที่สุด ซึ่งหลายคนก็อาจสามารถแยกแยะด้วยตัวเองได้ว่าข่าวไหนเป็นข่าวจริง ข่าวไหนเป็นข่าวปลอม</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        แล้วน้องๆรู้ไหมครับว่า การ ที่เราแชร์ข่าวปลอมไปผล ของมันจะเป็นอย่างไร ลอง มาติดตามวิดีโอนี้กันครับ
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C4Unit1MediumIntro'}"><a class="waves-effect light-green darken-1 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C4Unit1MediumIntro'}"><a class="waves-effect light-green darken-1 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C4Unit1MediumRound1P2'}"><a @click="submit" class="waves-effect light-green darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C4Unit1MediumRound1P2'}"><a @click="submit" class="waves-effect light-green darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
