    ...
    <div class="unit container center col s12 m12 l12" style="margin-top:20px">
        ...
        <div class="row card-panel light-green accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s5 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                            จากเหตุการณ์ที่ผ่านมา ถ้าน้องๆเป็นชายฟิน น้องๆ จะทำอะไรก่อน
                    </div>
        ...
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 light-green accent-1  white-text row" style="margin-top:4%;">
                        <div class="card-panel light-green darken-1 col s12 m12 l12 center-align">
                                <h4 style="font-weight:bold;"> 1.</h4>
                                <p class="flow-text">หาข้อเท็จจริง แล้วแชร์ต่อ ว่าความจริงเป็นอย่างไร</p>
                        ...
                        <div class="card-panel light-green darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">แชร์บอกเพื่อนๆให้เร็วที่สุด</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
...
export default {
    ...
    methods:{
        ...
        TimeCal:function(Email){
            ...
            let ref = db.collection('UserData').doc('Content').collection('Chapter4').doc('Unit1').collection('Level').doc('Medium').collection('Content').doc(Email);
        ref.get(getOptions).then(function(doc){
            ...
            db.collection('UserData').doc('Content').collection('Chapter4').doc('Unit1').collection('Level').doc('Medium').collection('Content').doc(Email).update(item)
            db.collection('UserData').doc('Loging').collection('Chapter4').doc('Unit1').collection('Level').doc('Medium').collection('Chapter4Unit1MediumLoging').doc(Email).update(item)
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C4Unit1MediumRound1P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
