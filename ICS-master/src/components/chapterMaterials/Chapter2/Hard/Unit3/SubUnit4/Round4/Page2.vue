    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">
            ...
            <div class="row card-panel pink lighten-5 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    <div class="left-align flow-text col s12 m12 l12 center"><h5 style="font-weight:bold;"> กรณีศึกษา </h5></div> 
            </div>   
            ...
            <div class="card-panel pink darken-1 s12 m12 l12 white" style="padding:0px;">
                <div class="card-content col s12 m12 l12 white-text" style="padding:0px;margin:0px;">
                    <iframe width="853" height="480" src="//www.youtube.com/embed/xkcHk71QRuw" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left-align" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        นอกจากมีความรู้เรื่องกฎ หมาย พ.ร.บ. คอมพิวเตอร์ ปี 2560 ฉบับที่ 2 แล้ว น้องๆ ยังสามารถนำมาเป็นเกราะ ป้องกันทั้งตนเอง ครอบครัว และคนอื่นๆได้ โดยการอัพ เดตข้อมูลจากแหล่งที่เชื่อ ถือและนำมาใช้ได้อย่าง เหมาะสมก็จะรอดปลอดภัย ไม่ถูกเอาเปรียบได้ครับ
                    </div>
            ...
            <div class="left col s6 m12 l6 hide-on-small-only">
                <router-link :to="{name:'C2Unit3HardRound4P1'}"><a class="waves-effect pink lighten-3 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
            </div>
            <div class="left col s6 m12 l6 hide-on-med-and-up">
                <router-link :to="{name:'C2Unit3HardRound4P1'}"><a class="waves-effect pink lighten-3 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
            </div>
            <div class="right col s6 m12 l6 hide-on-small-only">
                <router-link :to="{name:'C2Unit3HardRound4P3'}"><a @click="submit" class="waves-effect pink lighten-3 waves-light flow-text btn-large align-center right"> หน้าถัดไป </a></router-link>
            </div>
            <div class="right col s6 m12 l6 hide-on-med-and-up">
                <router-link :to="{name:'C2Unit3HardRound4P3'}"><a @click="submit" class="waves-effect pink lighten-3 waves-light flow-text btn-small align-center right"> หน้าถัดไป </a></router-link>
            </div> 
