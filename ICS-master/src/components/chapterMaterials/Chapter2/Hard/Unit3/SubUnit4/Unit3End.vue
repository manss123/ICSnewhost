    ...
    methods:{
        ...
        GetEmail:function(userTable){
         ...
         UpdateStatus:function(userTable,RecordTime,SequenceData,UnitTime){
            let self = this;
            var getOptions={ source: 'server'};
            let LoggingRef = db.collection('UserData').doc('Loging').collection('Chapter2').doc('Unit3').collection('Level').doc('Hard').collection('Chapter2Unit3HardLoging').doc(userTable).collection('Chapter2Unit3HardSequence').doc(UnitTime)
