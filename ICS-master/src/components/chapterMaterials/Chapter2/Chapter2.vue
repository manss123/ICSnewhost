<template>
    ...
    <div class="unit container center col s12 m12 l12 row" style="margin-top:20px">
        ...
        <div class="row card-panel pink darken-1 s12 m12 l12 valign-wrapper white-text">
                    ...
                    <div class="left-align flow-text col s8 m8 l8 left" style="margin:0%;font-weight:bold;">ฝึกความคิดและจิตใจ ไปกับโมโม่จัง</div> 
        </div>
        ...
        <div class="card-panel container col s12 m10 l10 pink darken-1 offset-m1 offset-l1" style="margin-top:4%;">
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            ...
                            <p class="flow-text col s12 m12 l12" style="margin-top:5px;margin-bottom:2%;padding:2%;font-weight:bold;">คิดก่อนแชร์</p>
                     ...
                     <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter2/unit2.2.png" style="margin-top:12px" alt="" class="responsive-img circle col s10 m4 l4 offset-s1 offset-m4 offset-l4">
                            <p class="flow-text col s12 m12 l12" style="margin-top:5px;margin-bottom:2%;padding:0px;font-weight:bold;">ตั้งสติก่อนแชร์</p>
                    ...
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter2/unit2.3.png" style="margin-top:12px" alt="" class="responsive-img circle col s10 m4 l4 offset-s1 offset-m4 offset-l4">
                            <p class="flow-text col s12 m12 l12" style="margin-top:5px;margin-bottom:2%;padding:0px;font-weight:bold;">รู้กฏ(หมาย)ก่อนแชร์</p>
...
export default {
    ...
    methods:{
        ...
        DoneStatusCheck:function(userTable){
            ...
            let Chapter2Status = db.collection('UserData').doc('Progress').collection('Chapter2').doc(userTable)
            Chapter2Status.get(getOptions).then(function(doc){
        ...
        QuizCheck:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter2StatusRef = db.collection('UserData').doc('Progress').collection('Chapter2').doc(userTable)
            Chapter2StatusRef.get(GetOptions).then(function(doc){
        ...
        QuizTest:function(){
            this.$router.push({name:'Chapter2QuizIntro'});
        },

        GetCurrentStatus:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter2Ref = db.collection('UserData').doc('Status').collection('Chapter2').doc(userTable)
            Chapter2Ref.get(GetOptions).then(function(doc){
...
/////////////////////////////  Unit1 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C2Unit1EasyIntro'})
            let unit = 'Unit1'
            let level = 'Low'
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
            self.$router.push({name: 'C2Unit1MediumIntro'})
            let unit = 'Unit1'
            let level = 'Medium'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
            self.$router.push({name: 'C2Unit1HardIntro'})
            let unit = 'Unit1'
            let level = 'Good'
            self.RecordLog(unit,level)
...
//////////////////////////////////////////////// Unit 2 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C2Unit2EasyIntro'})
                let unit = 'Unit2'
            let level = 'Low'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C2Unit2MediumIntro'})
                let unit = 'Unit2'
            let level = 'Medium'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C2Unit2HardIntro'})
                let unit = 'Unit2'
            let level = 'Good'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C2Unit3EasyIntro'})
                let unit = 'Unit3'
            let level = 'Low'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C2Unit3MediumIntro'})
                let unit = 'Unit3'
            let level = 'Medium'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C2Unit3HardIntro'})
                let unit = 'Unit3'
            let level = 'Good'
            self.RecordLog(unit,level)
