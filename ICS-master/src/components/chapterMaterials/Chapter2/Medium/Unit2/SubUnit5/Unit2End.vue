    ...
    methods:{
        ...
        GetEmail:function(userTable){
         ...
         UpdateStatus:function(userTable,RecordTime,SequenceData,UnitTime){
            let self = this;
            var getOptions={ source: 'server'};
            let LoggingRef = db.collection('UserData').doc('Loging').collection('Chapter2').doc('Unit2').collection('Level').doc('Medium').collection('Chapter2Unit2MediumLoging').doc(userTable).collection('Chapter2Unit2MediumSequence').doc(UnitTime)
            ...
            LoggingRef.get(getOptions).then(function(doc){
                ...
                let Unit2Time = doc.data().Round1Page1Time.AllSecond + doc.data().Round1Page2Time.AllSecond + doc.data().Round2Page1Time.AllSecond + doc.data().Round2Page2Time.AllSecond
                            ...
                            + doc.data().Round5Page1Time.AllSecond + doc.data().Round5Page2Time.AllSecond + doc.data().Round5Page3Time.AllSecond;
                let Unit2Score = doc.data().Round2Log.Correct + doc.data().Round4Log.Correct;
                
                let Total = (Unit2Time/8)
                console.log("Time "+Unit2Time);
                console.log("Score "+Unit2Score);
