    ...
    methods:{
        ...
        GetEmail:function(userTable){
         ...
         UpdateStatus:function(userTable,RecordTime,SequenceData,UnitTime){
            let self = this;
            var getOptions={ source: 'server'};
            let LoggingRef = db.collection('UserData').doc('Loging').collection('Chapter2').doc('Unit2').collection('Level').doc('Easy').collection('Chapter2Unit2EasyLoging').doc(userTable).collection('Chapter2Unit2EasySequence').doc(UnitTime)
