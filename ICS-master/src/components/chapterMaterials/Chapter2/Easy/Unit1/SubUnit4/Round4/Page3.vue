        ...
        <div class="row card-panel pink lighten-5 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s5 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                            ถ้าพี่โมโม่กดไลค์ ข่าวสาร ที่ทำให้เกิดความเสื่อมเสีย ต่อสถาบัน โดยที่ไม่ได้ตั้งใจ ถือว่าพี่โมโม่ทำผิดไหมครับ เพราะอะไร
                    </div>
        ...
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 pink lighten-5 white-text row" style="margin-top:4%;">
                        <div class="card-panel pink darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ไม่ผิด เพราะแค่กดไลค์</p>
                        ...
                        <div class="card-panel pink darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ผิด เพราะว่ากดไลค์ข้อมูลที่ทำ ให้เกิดความเสื่อมเสียต่อสถาบัน</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
                        ...
                        <div class="card-panel pink darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ไม่ผิด เพราะ พี่โมโม่ ไม่ได้ตั้งใจ</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C2Unit1EasyRound4P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
