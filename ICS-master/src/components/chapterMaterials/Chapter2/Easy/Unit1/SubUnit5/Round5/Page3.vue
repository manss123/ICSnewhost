        ...
        <div class="container center col s12 m12 l12" style="margin-top:1%;">
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left-align" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        มาดูกันอีกทีนะครับว่า ปู่มหามุนี ผิดข้อหาอะไรบ้าง
                    </div>
                    <img src="https://dlabi.com/project/interactive-computing-science/Materials/Momo/momofinal.gif" alt="" class="col s6 m3 l3">
            </div>  

            <div class="card-panel s12 m12 l12 white">
                <div class="card-content transparent col s12 m12 l12 black-text" style="padding:20px;margin:0px;">
                    <h5 class="center">ปู่มหานุนิ และพวก ทำผิด พ.ร.บ.คอมพิวเตอร์ พ.ศ.2560 ฉบับที่ 2</h5>
                    <p class="flow-text left-align"> มาตรา 14 (4) เป็นการนําเข้าสู่ระบบคอมพิวเตอร์ซึ่งข้อมูลคอมพิวเตอร์ใดๆ ที่มีลักษณะอันลามกและข้อมูลคอมพิวเตอร์นั้น ประชาชนทั่วไปอาจเข้าถึงได้ ข้อหาดังกล่าวมีอัตราโทษจําคุกไม่เกินห้าปี หรือปรับไม่เกินหนึ่งแสนบาท หรือทั้งจําทั้งปรับ<br>
                    <br>
                    และอีกข้อหาตาม พ.ร.บ.การพนัน พ.ศ.2478 ม.12 ด้วยเพราะฝ่ายชายรายหนึ่งได้มีการชักชวนคนดูคลิปการไลฟ์สดนั้นเข้าไปสมัครเป็นสมาชิกเว็บไซต์ที่เป็นกลุ่มที่มีการเล่นพนันจริง
                    </p>
                </div>
            </div>
             
            <div class="left col s6 m12 l6 hide-on-small-only">
                <router-link :to="{name:'C2Unit1EasyRound5P2'}"><a class="waves-effect pink lighten-3 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
            </div>
            <div class="left col s6 m12 l6 hide-on-med-and-up">
                <router-link :to="{name:'C2Unit1EasyRound5P2'}"><a class="waves-effect pink lighten-3 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
            </div>
            <div class="right col s6 m12 l6 hide-on-small-only">
                <router-link :to="{name:'C2Unit1EasyRound5P4'}"><a @click="submit" class="waves-effect pink lighten-3 waves-light flow-text btn-large align-center right"> หน้าถัดไป </a></router-link>
            </div>
            <div class="right col s6 m12 l6 hide-on-med-and-up">
                <router-link :to="{name:'C2Unit1EasyRound5P4'}"><a @click="submit" class="waves-effect pink lighten-3 waves-light flow-text btn-small align-center right"> หน้าถัดไป </a></router-link>
            </div> 
