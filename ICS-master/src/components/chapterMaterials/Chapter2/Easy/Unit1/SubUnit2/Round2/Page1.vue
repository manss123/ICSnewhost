    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">
            ...
            <div class="row card-panel pink lighten-5 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">ในบางครั้ง โซเชียลมีเดียที่น้องๆเล่นนั้นอาจกำลังแอบเก็บข้อมูลของน้องๆโดยไม่รู้ตัว ทั้งจากการท่องเว็บไซต์ การกดไลค์ในสิ่งที่ชอบ หรือกระทั่งการโพสต์ข้อความของตนเอง ดังนั้นเพื่อปกป้องความเป็นส่วนตัวและข้อมูลสำคัญๆของตนเอง น้องๆควรระมัดระวังในการเขียนข้อความหรือโพสต์ในช่องทางโซเชียลมีเดียนะครับ</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        พี่โมโม่ มี 10 สิ่งที่น้องๆไม่ ควรเปิดเผยบนโซเชียลมี เดีย อยากรู้ไหมครับตาม พี่โมโม่มาเลย
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C2Unit1EasyRound1P1'}"><a class="waves-effect pink lighten-3 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C2Unit1EasyRound1P1'}"><a class="waves-effect pink lighten-3 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C2Unit1EasyRound2P2'}"><a @click="submit" class="waves-effect pink lighten-3 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C2Unit1EasyRound2P2'}"><a @click="submit" class="waves-effect pink lighten-3 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
