    ...
    <div class="unit container center col s12 m12 l12" style="margin-top:20px">
        ...
        <div class="row card-panel pink lighten-5 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s8 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                            น้องๆชอบดูสื่อโซเชียลมี เดียแบบไหนมากที่สุด?
                    </div>
                    <p class="col s5 m6 l6 right">
                         <img src="http://167.71.221.10/ics//Materials/Momo/momofinal.gif" class="responsive-img col s12 m12 l12">
                    </p> 
            </div>  
        
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 pink lighten-5 white-text row" style="margin-top:4%;">
                        <div class="card-panel pink darken-1 col s12 m12 l12 center-align">
                                <h4 style="font-weight:bold;"> 1.</h4>
                                <p class="flow-text">วิดีโอ</p>
                        ...
                        <div class="card-panel pink darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">กราฟิกและภาพถ่าย</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
                        ...
                        <div class="card-panel pink darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">อินโฟกราฟิก</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
...
export default {
    ...
    methods:{
        ...
        ref.get(getOptions).then(function(doc){
            let StartHourP3 = doc.data().Round3Page3Start.StartTimeHour;
            let EndHourP3 = doc.data().Round3Page3End.EndTimeHour;
            let FinalHourP3 = Math.abs(EndHourP3-StartHourP3)*3600;

            let StartMinuteP3 = doc.data().Round3Page3Start.StartTimeMinute;
            let EndMinuteP3 = doc.data().Round3Page3End.EndTimeMinute;
            let FinalMinuteP3 = Math.abs(EndMinuteP3-StartMinuteP3)*60;

            let StartSecondP3 = doc.data().Round3Page3Start.StartTimeSecond;
            let EndSecondP3 = doc.data().Round3Page3End.EndTimeSecond;
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            db.collection('UserData').doc('Content').collection('Chapter2').doc('Unit1').collection('Level').doc('Easy').collection('Content').doc(self.userTable).update(item).then(res=>{
                      self.Round3Page4End="";
                      self.Round3Page5Start="";
                      
            })
            self.$router.push({name: 'C2Unit1EasyRound3P5'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
