          ...
          <hooper ref="myCarousel2" :itemsToShow="1" :centerMode="false" :infiniteScroll="true" style="height:300px;">
            ...
            <hooper-pagination slot="hooper-addons"></hooper-pagination>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C5Unit3EasyRound1P1'}"><a class="waves-effect  red darken-1 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s6 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C5Unit3EasyRound1P1'}"><a class="waves-effect  red darken-1 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C5Unit3EasyRound1P3'}"><a @click="submit" class="waves-effect  red darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s6 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C5Unit3EasyRound1P3'}"><a @click="submit" class="waves-effect  red darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
  </div>
  <!-- 1 -->
 <vue-modaltor :visible="open1" @hide="open1 = false" :bg-overlay="''" :bg-panel ="'white'" :default="'#fff'" :resize-width='{1200:"60%",992:"80%",768:"90%"}'>
      <p>
        <template slot="close-icon">
          ...
          &nbsp;&nbsp; เป็นเทคโนโลยีที่มีการเชื่อมต่อกับเครือข่ายภายนอก ซึ่งในปัจจุบันกำลังเป็นที่นิยมกับหน่วยงานหลายแห่งที่มีสำนักงาน หรือสาขาย่อย อยู่ตามสถานที่ต่างๆ ไว้ใช้สำหรับเป็นระบบที่ใช้ในการเชื่อมโยงแต่ละสำนักงานนั่นเอง และ ถูกใช้เพื่อป้องกันการเข้าชมเว็บส่วนตัวจากการถูกสอดแนม การแทรกแซง และการเซ็นเซอร์<br>
      </p>
  </vue-modaltor>
  <!-- 2 -->
