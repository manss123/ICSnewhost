        ...
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="card-panel s12 m12 l12 red darken-1" style="padding:0px;">
                <div class="card-content col s12 m12 l12 white-text" style="padding:0px;margin:0px;">
                    <iframe width="853" height="480" src="//www.youtube.com/embed/VsRNCgm1tDY" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left-align" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        น้องๆว่าคอมพิวเตอร์ของ ชายมินทร์โดนอะไรครับ
                    </div>
            ...
            <div class="right col s6 m12 l6 hide-on-small-only">
                <router-link :to="{name:'C5Unit1HardRound1P3'}"><a @click="submit" class="waves-effect red darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
            </div>
            <div class="right col s6 m12 l6 hide-on-med-and-up">
                <router-link :to="{name:'C5Unit1HardRound1P3'}"><a @click="submit" class="waves-effect red darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
            </div> 
