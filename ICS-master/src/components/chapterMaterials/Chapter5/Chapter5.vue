<template>
    ...
    <div class="unit container center col s12 m12 l12 row" style="margin-top:20px">
        ...
        <div class="row card-panel red darken-1 s12 m12 l12 valign-wrapper white-text">
                    ...
                    <img src="https://dlabi.com/project/interactive-computing-science/Materials/6lesson/Unit5icon.png" alt="" class="circle responsive-img col s10 m4 l4 right right-align offset-l4">
                    </div>
        ...
        <div class="card-panel container col s12 m10 l10 red accent-1 offset-m1 offset-l1" style="margin-top:4%;">
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                     ...
                     <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter5/unit5.2.png" style="margin-top:12px" alt="" class="responsive-img circle col s10 m4 l4 offset-s1 offset-m4 offset-l4">
                    ...
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter5/unit5.3.png" style="margin-top:12px" alt="" class="responsive-img circle col s10 m4 l4 offset-s1 offset-m4 offset-l4">
        ...
        <div class="col s12 m12 l12">
            <router-link :to="{name: 'UnitHome'}"><a class="waves-effect red darken-1 btn-large col s4 m4 l2 flow-text">ย้อนกลับ</a></router-link>
          </div>
...
export default {
    ...
    methods:{
        ...
        DoneStatusCheck:function(userTable){
            ...
            let Chapter5Status = db.collection('UserData').doc('Progress').collection('Chapter5').doc(userTable)
            Chapter5Status.get(getOptions).then(function(doc){
        ...
        QuizCheck:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter5StatusRef = db.collection('UserData').doc('Progress').collection('Chapter5').doc(userTable)
            Chapter5StatusRef.get(GetOptions).then(function(doc){
        ...
        QuizTest:function(){
            this.$router.push({name:'Chapter5QuizIntro'});
        },

        GetCurrentStatus:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter5Ref = db.collection('UserData').doc('Status').collection('Chapter5').doc(userTable)
            Chapter5Ref.get(GetOptions).then(function(doc){
...
/////////////////////////////  Unit1 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C5Unit1EasyIntro'})
            let unit = 'Unit1'
            let level = 'Low'
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
            self.$router.push({name: 'C5Unit1MediumIntro'})
            let unit = 'Unit1'
            let level = 'Medium'
            self.RecordLog(unit,level)
...
//////////////////////////////////////////////// Unit 2 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C5Unit2EasyIntro'})
                let unit = 'Unit2'
            let level = 'Low'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C5Unit2MediumIntro'})
                let unit = 'Unit2'
            let level = 'Medium'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C5Unit3EasyIntro'})
                let unit = 'Unit3'
            let level = 'Low'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C5Unit3MediumIntro'})
                let unit = 'Unit3'
            let level = 'Medium'
            self.RecordLog(unit,level)
