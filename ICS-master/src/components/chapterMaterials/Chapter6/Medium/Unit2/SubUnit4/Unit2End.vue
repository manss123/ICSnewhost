        ...
        <div class="container col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="col s12 m12 l12 row">
                    <div class="box box-bg sb12 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        เป็นยังไงบ้างครับ น่าตกใจไม่น้อยเลยใช่ไหมครับ
กับข้อดีและข้อเสียของการซื้อของออนไลน์ ในรูปแบบต่าง ๆ ยังไงก็ตามเวลาที่น้อง ๆ จับจ่ายซื้อของออนไลน์ก็อยากให้ระมัดระวังเรื่องการใช้จ่ายกันด้วยนะครับ
                    </div>
    ...
    methods:{
        ...
        GetEmail:function(userTable){
         ...
         UpdateStatus:function(userTable,RecordTime,SequenceData,UnitTime){
            let self = this;
            var getOptions={ source: 'server'};
            let LoggingRef = db.collection('UserData').doc('Loging').collection('Chapter6').doc('Unit1').collection('Level').doc('Medium').collection('Chapter6Unit2MediumLoging').doc(userTable).collection('Chapter6Unit2MediumSequence').doc(UnitTime)
