        ...
        <div class="row card-panel yellow accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s6 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                        ใครต่อไปนี้ปฏิบัติตัวดีที่สุด ก่อนการสั่งซื้อสินค้าออนไลน์
                    </div>
        ...
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 yellow accent-1 white-text row" style="margin-top:4%;">
                        <div class="card-panel yellow darken-2 lighten-3 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ชายมินทร์ สั่งซื้อสินค้าบนเฟซบุ๊ก<br>ที่คนรู้จักแนะนำ</p>
                        ...
                        <div class="card-panel yellow darken-2 lighten-3 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">มีนา เลือกซื้อกระเป๋าแบรนด์เนม<br>จากเว็บไซต์</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
                        ...
                        <div class="card-panel yellow darken-2 lighten-3 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ท้องฟ้า เลือกซื้อเฉพาะร้านที่มี<br>การจดทะเบียนพาณิชย์อิเล็ก<br>ทรอนิกส์กับกระทรวงพาณิชย์</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
    ...
    methods:{
        ...
        TimeCal:function(Email){
            var getOptions = {
              ...
              var self = this;
            let ref = db.collection('UserData').doc('Content').collection('Chapter6').doc('Unit3').collection('Level').doc('Medium').collection('Content').doc(Email);
        ref.get(getOptions).then(function(doc){
            ...
            SequenceRef.get().then(function(doc){
             ...
             db.collection('UserData').doc('Loging').collection('Chapter6').doc('Unit1').collection('Level').doc('Medium').collection('Chapter6Unit3MediumLoging').doc(Email).collection('Chapter6Unit3MediumSequence').doc(self.UnitTime).update(item).then(res=>{
                    self.UnitTime=""; 
            })
            })

            db.collection('UserData').doc('Content').collection('Chapter6').doc('Unit3').collection('Level').doc('Medium').collection('Content').doc(Email).update(item)
            db.collection('UserData').doc('Loging').collection('Chapter6').doc('Unit3').collection('Level').doc('Medium').collection('Chapter6Unit3MediumLoging').doc(Email).update(item)
            // // console.log(StartSecond,EndSecond);
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C6Unit3MediumRound2P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
