    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel yellow accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">สินค้าที่มีการขายผ่านช่องทางออนไลน์ที่ประชาชนจะถูกหลอกลวงส่วนใหญ่ คือ สินค้าแบรนด์เนมที่มีราคาแพง เช่น กระเป๋า รองเท้า นาฬิกา ส่วนบริการออนไลน์ที่มักจะโดนหลอกลวง ได้แก่ การจองตั๋วเครื่องบิน และการจองทัวร์ ฯลฯ และมักจะไม่ได้สินค้าตรงตามความต้องการของผู้ซื้อ</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        พี่โมโม่จะพาน้องมารู้จัก วิธีป้องกันการโดนโกงจาก การซื้อสินค้าออนไลน์กัน ครับ
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C6Unit3MediumRound1P1'}"><a class="waves-effect yellow darken-2 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C6Unit3MediumRound1P1'}"><a class="waves-effect yellow darken-2 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C6Unit3MediumRound2P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C6Unit3MediumRound2P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
