    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel yellow accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter6/unit6.3.png" alt="" class="circle responsive-img col s10 m4 l4 right right-align offset-l4">
                    </div>
                    <div class="left-align flow-text col s8 m8 l8 left"><h5 style="font-weight:bold;"> รู้ไว้...เงินไม่ไหล </h5></div> 
            </div>

                    <div class="card yellow darken-2 col s12 m12 l12 white-text" style="padding:30px;margin-bottom:30px;">
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">ในการซื้อสินค้าออนไลน์ผ่านทางผู้ค้าออนไลน์ทางอินเทอร์เน็ต ก็มักจะพบกับสินค้าบางอย่างที่ต้องถามราคา และต้องมาถามราคาทาง Inbox ของ Facebook page หรือ Line กันเข้ามา แต่รู้หรือไม่ว่า แค่ Inbox ถามราคา ผู้ค้าออนไลน์ก็ผิดกฎหมายการขายของออนไลน์แล้ว แค่ประเด็นนี้ก็โดนปรับสูงสุด  1 หมื่นบาทเลยทีเดียว</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        น้องๆรู้ไหมครับถ้าเราจะ ขายของออนไลน์เราต้อง โพสต์อะไรบ้างนอกจากรูป สินค้า พี่โมโม่จะบอกให้ครับ
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C6Unit3MediumRound4P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C6Unit3MediumRound4P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
