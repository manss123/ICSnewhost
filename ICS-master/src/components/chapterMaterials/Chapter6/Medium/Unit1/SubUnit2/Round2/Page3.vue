        ...
        <div class="row card-panel yellow accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s6 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                            เงินประเภทใดต่อไปนี้เมื่อเก็บ ไว้นานๆ เราจะได้ดอกเบี้ยเพิ่มขึ้น
                    </div>
        ...
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 yellow accent-1 white-text row" style="margin-top:4%;">
                        <div class="card-panel yellow darken-2 lighten-3 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">บัตรเครดิต</p>
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C6Unit1MediumRound2P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
