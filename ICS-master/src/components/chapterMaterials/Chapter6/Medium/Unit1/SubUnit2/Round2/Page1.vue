    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel yellow accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">เงินหมายถึง สิ่งที่สังคมยอมรับสำหรับใช้เป็นสื่อกลางในแลกเปลี่ยนสินค้าและบริการ ใช้ในการชำระหนี้หรืออื่นๆตามต้องการ และมีมูลค่าค่อนข้างคงที่ แต่ในปัจจุบันเงินไม่ได้มีเพียงแค่ธนบัตรและเหรียญเท่านั้น</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        รูปแบบของเงินในปัจจุบัน มีหลากหลาย น้องๆมาติด ตามดูไปพร้อมๆกันเลยครับ
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C6Unit1MediumRound1P1'}"><a class="waves-effect yellow darken-2 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C6Unit1MediumRound1P1'}"><a class="waves-effect yellow darken-2 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C6Unit1MediumRound2P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C6Unit1MediumRound2P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
