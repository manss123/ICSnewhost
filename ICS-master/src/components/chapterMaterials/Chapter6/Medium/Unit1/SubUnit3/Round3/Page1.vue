    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel yellow accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter6/unit6.1.png" alt="" class="circle responsive-img col s10 m4 l4 right right-align offset-l4">
                    </div>
                    <div class="left-align flow-text col s8 m8 l8 left"><h5 style="font-weight:bold;"> เงินไม่ใช่เงิน </h5></div> 
            </div>

                    <div class="card yellow darken-2 col s12 m12 l12 white-text" style="padding:30px;margin-bottom:30px;">
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">เงิน คือค่ากลางใช้สำหรับแลกเปลี่ยนสินค้าและบริการต่างๆ ซึ่งในปัจจุบันเงินไม่จำเป็นจะต้องเป็นเงินสด เสมอไปเนื่องจากมีการพัฒนารูปแบบของเงินให้หลากหลายมากขึ้น จึงทำให้เข้าสู่ยุคของสังคมไร้เงินสด</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        สังคมไร้เงินสด แต่เปลี่ยน ไปอยู่บนบัตรแทน หรือที่ เราเรียกว่า บัตรเครดิตหรือ บัตรเดบิต แต่น้องๆทราบ ไหมครับว่า บนบัตรที่เรา เห็นกันมีอักษรย่ออะไรที่ เราควรรู้บ้าง
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C6Unit1MediumRound3P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C6Unit1MediumRound3P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
