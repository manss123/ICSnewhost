    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel yellow accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">การใช้บัตรเครดิตหรือบัตรเดบิตทำให้เราสะดวกสบายมากขึ้นเป็นอย่างมาก แต่การใช้นั้นก็ต้องระมัดระวัง มิฉะนั้นอาจจะโดนมิจฉาชีพหลอกลวงเอาข้อมูลของเราไปใช้ได้</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        คุณพ่อ คุณแม่ของน้อง ๆ มีบัตรเครดิตหรือว่าบัตรเดบิตกันหรือเปล่าครับ น้อง ๆ มาอ่านวิธีป้องกันการใช้งานแล้วเอาไปบอกต่อกันเถอะครับ
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C6Unit1MediumRound4P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C6Unit1MediumRound4P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
