    ...
    <div class="unit container center col s12 m12 l12">
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            ...
            <div class="row card-panel yellow accent-1 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">เชื่อว่ามีผู้คนมากมายในปัจจุบันเป็นหนี้บัตรเครดิตท่วมท้น ทำให้การเงินติดขัดมีปัญหาชักหน้าไม่ถึงหลัง เกิดความเครียดจนไม่รู้จะหาทางออกอย่างไร</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        พี่โมโม่จะมาแนะนำวิธีการ ใช้บัตรเครดิตที่ถูกต้อง แบบไม่ให้เดือดร้อนตัว ไม่ทำให้เป็นหนี้ ไม่ติด แบล็กลิสต์ และที่สำคัญยัง ช่วยให้คุณพ่อคุณแม่ของ น้องๆประหยัดเงินได้ด้วย
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C6Unit1MediumRound5P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C6Unit1MediumRound5P2'}"><a @click="submit" class="waves-effect yellow darken-2 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
