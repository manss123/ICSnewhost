<template>
    ...
    <div class="unit container center col s12 m12 l12 row" style="margin-top:20px">
        ...
        <div class="row card-panel yellow darken-2 s12 m12 l12 valign-wrapper white-text">
                    ...
                    <img src="https://dlabi.com/project/interactive-computing-science/Materials/6lesson/Unit6icon.png" alt="" class="circle responsive-img col s10 m4 l4 right right-align offset-l4">
                    </div>
                    <div class="left-align flow-text col s8 m8 l8 left" style="margin:0%;font-weight:bold;">ดีจังตังค์อยู่ครบ</div> 
        </div>
        ...
        <div class="card-panel container col s12 m10 l10 yellow accent-1 offset-m1 offset-l1" style="margin-top:4%;">
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            ...
                            <p class="flow-text col s12 m12 l12" style="margin-top:5px;margin-bottom:2%;padding:2%;font-weight:bold;">เงินไม่ใช่เงิน</p>
                     ...
                     <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter6/unit6.2.png" style="margin-top:12px" alt="" class="responsive-img circle col s10 m4 l4 offset-s1 offset-m4 offset-l4">
                            <p class="flow-text col s12 m12 l12" style="margin-top:5px;margin-bottom:2%;padding:0px;font-weight:bold;">ซื้อของจากกระเป๋าเงินในอากาศ</p>
                    ...
                    <div class="card-panel white col s8 m8 l8 center-align offset-s2 offset-m2 offset-l2" style="margin-top:30px;">
                            <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/Chapter6/unit6.3.png" style="margin-top:12px" alt="" class="responsive-img circle col s10 m4 l4 offset-s1 offset-m4 offset-l4">
                            <p class="flow-text col s12 m12 l12" style="margin-top:5px;margin-bottom:2%;padding:0px;font-weight:bold;">รู้ไว้...เงินไม่ไหล</p>
        ...
        <div class="col s12 m12 l12">
            <router-link :to="{name: 'UnitHome'}"><a class="waves-effect yellow darken-2 btn-large col s4 m4 l2 flow-text">ย้อนกลับ</a></router-link>
          </div>
...
export default {
    ...
    methods:{
        ...
        DoneStatusCheck:function(userTable){
            ...
            let Chapter6Status = db.collection('UserData').doc('Progress').collection('Chapter6').doc(userTable)
            Chapter6Status.get(getOptions).then(function(doc){
        ...
        QuizCheck:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter6StatusRef = db.collection('UserData').doc('Progress').collection('Chapter6').doc(userTable)
            Chapter6StatusRef.get(GetOptions).then(function(doc){
        ...
        QuizTest:function(){
            this.$router.push({name:'Chapter6QuizIntro'});
        },

        GetCurrentStatus:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter6Ref = db.collection('UserData').doc('Status').collection('Chapter6').doc(userTable)
            Chapter6Ref.get(GetOptions).then(function(doc){
...
/////////////////////////////  Unit1 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C6Unit1EasyIntro'})
            let unit = 'Unit1'
            let level = 'Low'
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
            self.$router.push({name: 'C6Unit1MediumIntro'})
            let unit = 'Unit1'
            let level = 'Medium'
            self.RecordLog(unit,level)
...
//////////////////////////////////////////////// Unit 2 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C6Unit2EasyIntro'})
                let unit = 'Unit2'
            let level = 'Low'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C6Unit2MediumIntro'})
                let unit = 'Unit2'
            let level = 'Medium'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C6Unit3EasyIntro'})
                let unit = 'Unit3'
            let level = 'Low'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C6Unit3MediumIntro'})
                let unit = 'Unit3'
            let level = 'Medium'
            self.RecordLog(unit,level)
