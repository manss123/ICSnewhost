    ...
    methods:{
        ...
        TimeCal:function(Email){
            var getOptions = {
              ...
              var self = this;
            let ref = db.collection('UserData').doc('Content').collection('Chapter6').doc('Unit3').collection('Level').doc('Hard').collection('Content').doc(Email);
        ref.get(getOptions).then(function(doc){
            ...
            SequenceRef.get().then(function(doc){
             ...
             db.collection('UserData').doc('Loging').collection('Chapter6').doc('Unit1').collection('Level').doc('Hard').collection('Chapter6Unit3HardLoging').doc(Email).collection('Chapter6Unit3HardSequence').doc(self.UnitTime).update(item).then(res=>{
                    self.UnitTime=""; 
            })
            })

            db.collection('UserData').doc('Content').collection('Chapter6').doc('Unit3').collection('Level').doc('Hard').collection('Content').doc(Email).update(item)
            db.collection('UserData').doc('Loging').collection('Chapter6').doc('Unit3').collection('Level').doc('Hard').collection('Chapter6Unit3HardLoging').doc(Email).update(item)
            // // console.log(StartSecond,EndSecond);
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C6Unit3HardRound2P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
