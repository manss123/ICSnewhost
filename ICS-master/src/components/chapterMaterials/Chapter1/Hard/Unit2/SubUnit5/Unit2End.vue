    ...
    methods:{
        ...
        GetEmail:function(userTable){
         ...
         UpdateStatus:function(userTable,RecordTime,SequenceData,UnitTime){
            let self = this;
            var getOptions={ source: 'server'};
            let LoggingRef = db.collection('UserData').doc('Loging').collection('Chapter1').doc('Unit2').collection('Level').doc('Hard').collection('Chapter1Unit2HardLoging').doc(userTable).collection('Chapter1Unit2HardSequence').doc(UnitTime)
