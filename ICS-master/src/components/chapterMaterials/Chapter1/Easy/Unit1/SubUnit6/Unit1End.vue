...
export default {
    ...
    methods:{
        ...
        UpdateStatus:function(userTable,RecordTime,SequenceData,UnitTime){
            let self = this;
            var getOptions={ source: 'server'};
            let LoggingRef = db.collection('UserData').doc('Loging').collection('Chapter1').doc('Unit1').collection('Level').doc('Easy').collection('Chapter1Unit1EasyLoging').doc(userTable).collection('Chapter1Unit1EasySequence').doc(UnitTime)
