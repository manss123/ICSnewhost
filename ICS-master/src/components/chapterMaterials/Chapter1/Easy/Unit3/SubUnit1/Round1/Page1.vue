    ...
    <div class="unit container center col s12 m12 l12">
        ...
        <div class="container center col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">ปัจจุบันการแฮกข้อมูลหรือรหัสผ่านนั้นเป็นไปได้มากขึ้น เพราะมีสิ่งอำนวยความสะดวกในการช่วยดึงข้อมูลมากมาย ทั้งจากเว็บไซต์ที่คอยช่วยเรื่องการแฮก หรือความรู้เกี่ยวกับคอมพิวเตอร์ของผู้คนสมัยนี้มีเพิ่มมากขึ้น ทำให้อัตราความปลอดภัยเกี่ยวกับการป้องกันข้อมูลของผู้ใช้งานเพิ่มขึ้นมากไปด้วย</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        ดูน่ากลัวจังเลยครับ แต่คงไม่เกิดขึ้นกับเราหรอกใช่มั้ย? 
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit3EasyIntro'}"><a class="waves-effect teal darken-1 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit3EasyIntro'}"><a class="waves-effect teal darken-1 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit3EasyRound1P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit3EasyRound1P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
