    ...
    <div class="unit black-text container center col s12 m12 l12">
        ...
        <div class="col s12 m12 l12" style="margin-top:2%">
            ...
            <div class="card-panel row teal darken-1 col s12 m12 l12" style="padding:10px;padding-bottom:10px;margin-top:30px;">
                ...
                <div class="col s12 m12 l12"> <p class="flow-text center white-text" style="font-weight:bold;"> น้องๆเคยเจอเหตุการณ์คล้ายกับเด็กชายมินทร์หรือไม่? </p></div>
                ...
                <!-- <div class="left col s12 m12 l12">
                        <router-link :to="{name:'C1Unit3EasyRound1P2'}"><a @click="submit" style="" class="waves-effect cyan darken-4 waves-light flow-text btn-large hide-on-small-only align-center left"> ย้อนกลับ </a></router-link>
                        <router-link :to="{name:'C1Unit3EasyRound1P2'}"><a @click="submit" style="" class="waves-effect cyan darken-4 waves-light flow-text btn-small hide-on-med-and-up align-center left"> ย้อนกลับ </a></router-link>
                </div> -->
 ...
 // ********* check user id
        ...
        let Gusers = db.collection("Gusers").orderBy("Email")
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C1Unit3EasyRound1P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
