    ...
    <div class="unit container col s12 m12 l12">
        <div class="container col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <p class="flow-text">การตั้งรหัสผ่านเป็นสิ่งสำคัญ หากไม่คำนึงหรือตั้งแบบง่ายเกินไป ผู้อื่นอาจแฮกและนำข้อมูลของน้องๆไปใช้ประโยชน์ได้โดยง่าย ก่อให้เกิดความเสียหายต่อตัวน้องๆเอง อีกทั้งการอัปเดตรหัสผ่านบ่อยๆนั้น จะทำให้เกิดความปลอดภัยมากขึ้นด้วยครับ</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit3EasyRound3P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit3EasyRound3P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
