    ...
    <div class="unit container center col s12 m12 l12">
        ...
        <div class="container center col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/unit1.3.png" alt="" class="circle responsive-img col s10 m4 l4 right right-align offset-l4">
                    </div>
                    <div class="left-align flow-text col s12 m8 l8 left"><h5 style="font-weight:bold;"> กำแพงส่วนตัว </h5></div> 
            </div>

                    <div class="card-content teal darken-1 col s12 m12 l12 white-text" style="padding:30px;margin-bottom:30px;">
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">น้องๆคงเคยได้ยินหรือได้ลองเล่นสองแอปนี้ใช่หรือไม่? แอปที่โดดเด่นเรื่องการแต่งภาพและลงรูปถ่าย Instagram และ แอปที่โดดเด่นในเรื่องการติดตามและลงข่าวสาร Twitter อีกทั้งทั้งสองแอปนี้น้องๆยังสามารถกดเลือกติดตามใครก็ได้บนโลกใบนี้อีกด้วยครับ แต่นั่นก็หมายถึงคนอื่นก็สามารถติดตามดูเราได้ด้วยเช่นกัน ดังนั้นน้องๆต้องระวังข้อมูลตัวเองให้มากๆนะครับ</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        พี่โมโม่จึงนำวิธีการตั้งค่าความเป็นส่วนตัวของ Instragram และ Twitter เบื้องต้นมาฝากกันครับ
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit3EasyRound5P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit3EasyRound5P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
