    ...
    <div class="unit container col s12 m12 l12">
        <div class="container col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <p class="flow-text">นอกจากตั้งค่าป้องกันไวรัสบนระบบปฎิบัติการ Windows 10 ของคอมพิวเตอร์แล้ว น้องๆยังสามารถป้องกันไวรัสหรือมัลแวร์ได้โดย
                        ใช้ความระมัดระวัง ในการดาวน์โหลดหรือติดตั้งโปรแกรมจากภายนอกลงบนเครื่อง</p>
                </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        ลองไปดูวิธีพิจารณาการดาวน์โหลดซอฟต์แวร์หรือโปรแกรมก่อนและระหว่างการดาวน์โหลดหรือติดตั้งลงบนคอมพิวเตอร์ของน้องๆกันครับ ตามพี่โมโม่มาเลย!
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit1MediumRound5P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit1MediumRound5P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
