        ...
        <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s6 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                            น้องๆคิดว่าภายในสามคนนี้ใครคิดจะทําหรือทําการติดตั้งโปรแกรมไม่ถูกต้อง?
                    </div>
                    <p class="col s6 m6 l6 right">
                         <img src="http://167.71.221.10/ics//Materials/Momo/momofinal.gif" class="responsive-img col s12 m12 l12">
                    </p> 
            </div>  
        
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 teal accent-2 white-text row" style="margin-top:4%;">
                        <div class="card-panel teal darken-1 col s12 m12 l12 center-align">
                                <h4 style="font-weight:bold;"> 1.</h4>
                                <p class="flow-text">มีนาอ่านคําวิจารณ์เกี่ยวกับโปรแกรมสแกนเอกสารของ Acrobye ในเว็บพันทิป (pantip)</p>
                        ...
                        <div class="card-panel teal darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">สายรุ้งเห็นว่าคอมพิวเตอร์ของตนมีพื้นที่ความจําอยู่มาก จึงดาวน์โหลดเกมบาร์บี้มาเหมือนกันทั้งสองเกม</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
                        ...
                        <div class="card-panel teal darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ชายฟินเลือกติดตั้งโปรแกรมลงไดร์ฟ C ที่เป็นไดร์ฟเริ่มต้นของคอมพิวเตอร์อยู่เสมอ</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C1Unit1MediumRound5P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
