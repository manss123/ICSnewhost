    ...
    <div class="unit container center col s12 m12 l12">
        ...
        <div class="container center col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">น้องๆสามารถทําให้คอมพิวเตอร์ของตนเองกลับมาทํางานได้ตามปกติโดยการทํา System Restore หรือ การย้อนเวลากลับไปยังจุดที่คอมพิวเตอร์ของน้องเคยบันทึกไว้เช่น ย้อนกลับไปยังจุดก่อนที่น้องจะลงโปรแกรมล่าสุดหรือย้อนกลับไปจุดที่คอมพิวเตอร์ ทํางานได้ดีและราบรื่น</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        น้องๆอยากรู้วิธีการคืนค่า ระบบกันไหมครับ ตามพี่ โมโม่มาเลยครับ
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit1MediumRound3P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit1MediumRound3P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
