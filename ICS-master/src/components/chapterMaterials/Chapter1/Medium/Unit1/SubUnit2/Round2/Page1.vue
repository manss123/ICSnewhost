    ...
    <div class="unit container col s12 m12 l12">
        <div class="container col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/unit1.1.png" alt="" class="circle responsive-img col s10 m4 l4 right right-align offset-l4">
                    </div>
                    <div class="left-align flow-text col s8 m8 l8 left"><h5 style="font-weight:bold;"> กำแพงคอมพิวเตอร์ </h5></div> 
            </div>
                ...
                <p class="flow-text">ถ้าคอมพิวเตอร์ของน้อง ๆ มีอาการดัง 5 ข้อด้านล่าง แสดงว่าคอมพิวเตอร์ของน้องเริ่มผิดปกติแล้วนะครับ<br>
                    1.เปิดและปิดคอมพิวเตอร์ช้า<br>
                    2.ปิดคอมพิวเตอร์ไม่ได้ ทั้งกดปิดปุ่ม Shutdown และปุ่ม Power <br>
                    3.คอมพิวเตอร์ไม่ตอบสนองหรือหยุดทำงานชั่วคราว<br>
                    4.คอมพิวเตอร์ทำงานช้ามาก<br>
                    5.พัดลมคอมพิวเตอร์ทำงานเร็วมากกว่าปกติ
                </p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        นอกจากเช็กได้ด้วยตัวเอง แล้ว ยังสามารถเช็กผ่าน เว็บไซต์ ได้ด้วยนะครับ ตามพี่โมโม่มาเลยครับ
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit1MediumRound1P1'}"><a class="waves-effect teal darken-1 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit1MediumRound1P1'}"><a class="waves-effect teal darken-1 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit1MediumRound2P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit1MediumRound2P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
