        ...
        <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s5 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                            เหตุการณ์ใดต่อไปนี้ที่บ่งบอก ถึงการทำงานที่ผิดปกติของ คอมพิวเตอร์?
                    </div>
        ...
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 teal accent-2 white-text row" style="margin-top:4%;">
                        <div class="card-panel teal darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ชายมินทร์อ่านการ์ตูนออนไลน์ ฟังเพลงด้วยความสบายใจ</p>
                        ...
                        <div class="card-panel teal darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">น้องสายรุ้งดูซีรีส์วันหยุดสุด สัปดาห์ด้วยความสนุกแม้ว่าจะดูไป กระตุกไป</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C1Unit1MediumRound2P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
