    ...
    <div class="unit black-text container center col s12 m12 l12">
        ...
        <div class="col s12 m12 l12" style="margin-top:2%">
            ...
            <div class="card-panel row teal darken-1 col s12 m12 l12" style="padding:10px;padding-bottom:10px;margin-top:30px;">
                ...
                <div class="col s12 m12 l12"> <p class="flow-text center white-text" style="font-weight:bold;"> เอ...ไหนน้องๆลองบอกจุดสังเกตให้พี่โมโม่ฟังหน่อยสิครับ ว่าตามในวิดีโอ เด็กชายมินทร์ทําสิ่งใด จนทําให้เล่นเกมไม่สนุก ถูกขัดอยู่ตลอดเวลา </p></div>
                <div class="col s12 m12 l12 row valign-wrapper" style="margin:0px;margin-top:20px;">
                    ...
                    <div class="right col s12 m12 l6 flow-text">
                        <router-link :to="{name:'C1Unit1MediumRound6P4'}"><a @click="submit" class="waves-effect grey darken-2 waves-light btn-large align-center right"> ส่งคำตอบ </a></router-link>
                    </div>
                </div>
                </div>
            </div>
                ...
                <!-- <div class="left col s12 m12 l12">
                        <router-link :to="{name:'C2Unit1MediumRound6P2'}"><a @click="submit" style="" class="waves-effect cyan darken-4 waves-light flow-text btn-large hide-on-small-only align-center left"> ย้อนกลับ </a></router-link>
                        <router-link :to="{name:'C2Unit1MediumRound6P2'}"><a @click="submit" style="" class="waves-effect cyan darken-4 waves-light flow-text btn-small hide-on-med-and-up align-center left"> ย้อนกลับ </a></router-link>
                </div> -->
...
export default {
    ...
    methods:{
        ...
        ref.get(getOptions).then(function(doc){
            ...
            let StartHourP1 = doc.data().Round6Page1Start.StartTimeHour;
            let EndHourP1 = doc.data().Round6Page1End.EndTimeHour;
            let FinalHourP1 = Math.abs(EndHourP1-StartHourP1)*3600;

            let StartMinuteP1 = doc.data().Round6Page1Start.StartTimeMinute;
            let EndMinuteP1 = doc.data().Round6Page1End.EndTimeMinute;
            let FinalMinuteP1 = Math.abs(EndMinuteP1-StartMinuteP1)*60;

            let StartSecondP1 = doc.data().Round6Page1Start.StartTimeSecond;
            let EndSecondP1 = doc.data().Round6Page1End.EndTimeSecond;
            ...
            let StartHourP2 = doc.data().Round6Page2Start.StartTimeHour;
            let EndHourP2 = doc.data().Round6Page2End.EndTimeHour;
            let FinalHourP2 = Math.abs(EndHourP2-StartHourP2)*3600;

            let StartMinuteP2 = doc.data().Round6Page2Start.StartTimeMinute;
            let EndMinuteP2 = doc.data().Round6Page2End.EndTimeMinute;
            let FinalMinuteP2 = Math.abs(EndMinuteP2-StartMinuteP2)*60;

            let StartSecondP2 = doc.data().Round6Page2Start.StartTimeSecond;
            let EndSecondP2 = doc.data().Round6Page2End.EndTimeSecond;
