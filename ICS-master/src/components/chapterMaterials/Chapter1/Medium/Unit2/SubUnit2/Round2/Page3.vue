        ...
        <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
         ...
         <div class="row container col s12 m6 l6 black-text valign-wrapper" style="margin-bottom:2%;">
                    <div class="box sb1 col s5 m6 l5 flow-text left-align" style="padding:2%;margin-bottom:1%;font-weight:bold;">
                            จากสถานการณ์ต่อไปนี้ น้องๆคิดว่าใครกำลังใช้งานเว็บไซต์ที่มีความเสี่ยงน้อยในการถูกแฮกข้อมูล?
                    </div>
        ...
        <div class="container col s12 m12 l12">
            <div class="card-panel col s12 m12 l12 teal accent-2 white-text row" style="margin-top:4%;">
                        <div class="card-panel teal darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">สายรุ้งเข้าใช้เว็บไซต์ https://webcartoonnaja.comด้านซ้ายมีปุ่มไอคอนล็อค ระหว่างอ่านการ์ตูนอย่างสนุกสนานมักมีโฆษณาขึ้นมาด้านซ้ายของจอบ้างในตอนที่เธอเปลี่ยนตอนใหม่ของการ์ตูน แต่เธอก็กดปิดทุกครั้งโดยไม่ใส่ใจ</p>
                        ...
                        <div class="card-panel teal darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">เด็กชายตั้มเข้าใช้งานเว็บที่มีสัญลักษณ์รับรองความปลอดภัยและ SSL หมดอายุเมื่ออาทิตย์ก่อนแต่ชายตั้มยังสามาถใช้งานเว็บไซต์ได้ตามปกติ โดยไม่ได้ตะขิดตะขวงใจใดๆ</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
                        ...
                        <!-- <div class="card-panel teal darken-1 col s12 m12 l12 center-align">
                                ...
                                <p class="flow-text">ตั้มนั่งทํารายงานในห้องขณะที่ คอมพิวเตอร์ของเขาเสียงดัง กว่าปกติ</p>
                                <div class="center col s12 m12 l12" style="margin-bottom:10px;">
 ...
 // ********* check user id
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C1Unit2MediumRound2P4'})
              });
          })
          .catch(function(error) {
              console.log("Error getting documents: ", error);
