    ...
    <div class="unit container col s12 m12 l12">
        <div class="container col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <img src="https://dlabi.com/project/interactive-computing-science/Materials/Icon%20-%20Unit/unit1.2.png" alt="" class="circle responsive-img col s10 m4 l4 right right-align offset-l4">
                    </div>
                    <div class="left-align flow-text col s8 m8 l8 left"><h5 style="font-weight:bold;"> กำแพงเว็บไซต์ </h5></div> 
            </div>

                    <div class="card-content teal darken-1 col s12 m12 l12 white-text" style="padding:30px;margin-bottom:30px;">
                <h4 class="center">มาเริ่มกันเลย</h4>
                <p class="flow-text">น้องๆเข้าใช้งานเว็บไซต์มากมายในทุกๆวัน แต่บางเว็บไซต์ที่เข้าไปใช้งานอาจเป็นเว็บที่ไม่ได้มาตรฐาน เว็บปลอม ไม่มีการรองรับว่าปลอดภัย อาจก่อให้เกิดผลกระทบตามมาอย่างคาดไม่ถึง เช่น คอมพิวเตอร์ติดไวรัส โดนแฮกข้อมูลโดยไม่รู้ตัว ข้อมูลส่วนตัวรั่วไหล ซึ่งเป็นสิ่งที่น้องๆควรระมัดระวังเป็นอย่างมากนะครับ</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        แล้วเราจะรู้ได้ยังไงว่าเว็บไซต์ไหนจริงหรือปลอม หรือเป็นเว็บไซต์ที่ปลอดภัยเหมาะแก่การใช้งานได้จริง? ตามพี่โมโม่มาเลยครับ 
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit2MediumRound1P1'}"><a class="waves-effect teal darken-1 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit2MediumRound1P1'}"><a class="waves-effect teal darken-1 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit2MediumRound2P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit2MediumRound2P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
