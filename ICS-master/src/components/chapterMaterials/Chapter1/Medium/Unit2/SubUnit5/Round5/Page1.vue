    ...
    <div class="unit container center col s12 m12 l12">
        ...
        <div class="container center col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                ...
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">การเข้าถึงสิทธิ์หรือข้อมูลของน้องๆ โดยบุคคลภายนอก ทั้งดีและไม่ดี อย่างการดาวน์โหลดบางอย่างจากเว็บไซต์ก็เช่นกัน น้องๆอาจเจอกับลิงก์ที่แฝงมากับปุ่มที่น้องจะกดดาวน์โหลดหรืออาจเด้งออกไปยังแท็บใหม่หรือมีหลากหลายปุ่มดาวน์โหลดให้น้องสุ่มกด ซึ่งหากน้องกดปุ่มดาวน์โหลดผิด อาจติดโฆษณาหรือไวรัสมาได้</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        ลองไปดูตัวอย่างวิธีการดาวน์โหลดกันเลยครับ
                    </div>
                    ...
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit2MediumRound5P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit2MediumRound5P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
