    ...
    <div class="unit container center col s12 m12 l12">
        ...
        <div class="container center col s12 m12 l12" style="margin-top:1%;">    
            ...
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    ...
                    <div class="card teal darken-1 col s12 m12 l12 white-text" style="padding:30px;margin-bottom:30px;">
                <h4>มาเริ่มกันเลย</h4>
                <p class="flow-text">น้องๆเคยรู้มั้ยครับว่าคำว่า ‘เว็บไซต์’ มีที่มาคืออะไร? มันก็คือ โครงข่ายใยแมงมุม ซึ่งเกิดจากการประสมคำของ Web ที่แปลว่า ใยแมงมุม และ Site ที่แปลว่า โครงข่าย ครับ หรือ เว็บไซต์(Website) ก็คือ กลุ่มของเว็บเพจที่เกี่ยวข้องและมีความสัมพันธ์กัน ประกอบไปด้วยเอกสาร(Document)และสื่อต่างๆ เช่น เสียง ภาพ ข้อความ เป็นต้น</p>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        เอ...น้องๆเคยได้สำรวจโครงข่ายใยแมงมุมบ้างรึเปล่านะ? พี่โมโม่เพิ่งได้รับคลิปแปลกประหลาดมา น้องๆมาดูร่วมกับพี่โมโม่กัน! 
                    </div>
                    ...
                    <div class="left col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit2MediumIntro'}"><a class="waves-effect teal darken-1 waves-light flow-text btn-large align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="left col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit2MediumIntro'}"><a class="waves-effect teal darken-1 waves-light flow-text btn-small align-center left"> ย้อนกลับ </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-small-only">
                                <router-link :to="{name:'C1Unit2MediumRound1P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
                    </div>
                    <div class="right col s12 m12 l6 hide-on-med-and-up">
                                <router-link :to="{name:'C1Unit2MediumRound1P2'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
                    </div> 
