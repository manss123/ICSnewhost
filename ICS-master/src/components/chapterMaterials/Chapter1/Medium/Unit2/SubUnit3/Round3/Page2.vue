    ...
    <div class="unit container center col s12 m12 l12">
        ...
        <div class="container center col s12 m12 l12" style="margin-top:1%;">  
            <div class="row card-panel teal accent-2 s12 m12 l12 valign-wrapper black-text" style="margin-top:10px;">
                    <div class="left-align flow-text col s12 m12 l12 center"><h5 style="font-weight:bold;"> ยอมรับซึ่งกันและกัน </h5></div> 
            </div>   
            ...
            <div class="card-panel teal darken-1 s12 m12 l12" style="padding:0px;">
                <div class="card-content col s12 m12 l12 white-text" style="padding:0px;margin:0px;">
                    <iframe width="853" height="480" src="//www.youtube.com/embed/6gY5xHkQtns" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
            ...
            <div class="col s12 m12 l12 valign-wrapper row">
                    <div class="box sb1 col s12 m12 l12 flow-text left-align" style="padding:8px;margin-bottom:1%;font-weight:bold;">
                        กดดูวิดีโอแล้วบอกพี่โมโม่หน่อยครับว่าน้องๆเคยทำเหมือนชายมินทร์รึเปล่าครับ?
                    </div>
            ...
            <div class="right col s6 m12 l6 hide-on-small-only">
                <router-link :to="{name:'C1Unit2MediumRound3P3'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-large align-center right"> ต่อไป </a></router-link>
            </div>
            <div class="right col s6 m12 l6 hide-on-med-and-up">
                <router-link :to="{name:'C1Unit2MediumRound3P3'}"><a @click="submit" class="waves-effect teal darken-1 waves-light flow-text btn-small align-center right"> ต่อไป </a></router-link>
            </div> 
