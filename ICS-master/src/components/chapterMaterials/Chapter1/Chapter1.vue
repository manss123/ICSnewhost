<template>
    ...
    <div class="unit container center col s12 m12 l12 row" style="margin-top:20px">
        ...
        <div class="row card-panel teal darken-1 s12 m12 l12 valign-wrapper white-text">
                    ...
                    <div class="left-align flow-text col s12 m8 l8 left" style="margin:0%;font-weight:bold;">สร้างพื้นที่ปลอดภัยด้วย SAFETY WALL</div> 
        </div>
        ...
        <div class="card-panel container col s12 m10 l10 teal accent-2 offset-m1 offset-l1" style="margin-top:4%;">
...
export default {
    ...
    methods:{
        ...
        DoneStatusCheck:function(userTable){
            ...
            let Chapter1Status = db.collection('UserData').doc('Progress').collection('Chapter1').doc(userTable)
            Chapter1Status.get(getOptions).then(function(doc){
                self.Unit1Done = doc.data().Unit1Status;
                self.Unit2Done = doc.data().Unit2Status;
                self.Unit3Done = doc.data().Unit3Status;
                console.log("Unit1: "+self.Unit1Done,doc.data().Unit1Status);
                console.log("Unit2: "+self.Unit2Done,doc.data().Unit2Status);
                console.log("Unit3: "+self.Unit3Done,doc.data().Unit3Status);
            })
        },
        ...
        QuizCheck:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter1StatusRef = db.collection('UserData').doc('Progress').collection('Chapter1').doc(userTable)
            Chapter1StatusRef.get(GetOptions).then(function(doc){
        ...
        QuizTest:function(){
            this.$router.push({name:'Chapter1QuizIntro'});
        },

        GetCurrentStatus:function(userTable){
            var GetOptions = { source: 'server'};
            let self = this;
            let Chapter1Ref = db.collection('UserData').doc('Status').collection('Chapter1').doc(userTable)
            Chapter1Ref.get(GetOptions).then(function(doc){
...
/////////////////////////////  Unit1 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
            ...
            self.$router.push({name: 'C1Unit1EasyIntro'})
            let unit = 'Unit1'
            let level = 'Low'
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
            self.$router.push({name: 'C1Unit1MediumIntro'})
            let unit = 'Unit1'
            let level = 'Medium'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
            self.$router.push({name: 'C1Unit1HardIntro'})
            let unit = 'Unit1'
            let level = 'Good'
            self.RecordLog(unit,level)
...
//////////////////////////////////////////////// Unit 2 Submit
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C1Unit2EasyIntro'})
                let unit = 'Unit2'
            let level = 'Low'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C1Unit2MediumIntro'})
                let unit = 'Unit2'
            let level = 'Medium'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                  // doc.data() is never undefined for query doc snapshots
                self.$router.push({name: 'C1Unit2HardIntro'})
                let unit = 'Unit2'
            let level = 'Good'
            self.RecordLog(unit,level)
              });
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C1Unit3EasyIntro'})
                let unit = 'Unit3'
            let level = 'Low'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C1Unit3MediumIntro'})
                let unit = 'Unit3'
            let level = 'Medium'
            self.RecordLog(unit,level)
        ...
        .limit(25);
          ...
          .then(function(querySnapshot) {
              querySnapshot.forEach(function(doc) {
                ...
                self.$router.push({name: 'C1Unit3HardIntro'})
                let unit = 'Unit3'
            let level = 'Good'
            self.RecordLog(unit,level)
